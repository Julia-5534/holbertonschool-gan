...
wandb.init(project="DCGAN", name="exp1")
...
if not os.path.exists('logs/exp1'):
    os.makedirs('logs/exp1')
...
for i in range(epochs):
    ...
    save_path = os.path.join('logs', 'exp1', f'image_at_epoch_{i:04d}.png')
    plt.show()
    plt.close()
    wandb.log({"EXP1 Generated Images": images})
