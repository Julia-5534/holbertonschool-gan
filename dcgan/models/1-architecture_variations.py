...
wandb.init(project="exp1-gan-mnist")

def discriminator():
  input = Input(shape=(28, 28, 1))
  # Third Achitecture Update
...
def generator(n):
  ...
  # Third Architecture Update --> Replaces lines 47-52
  # x = Dense(256, activation=LeakyReLU(alpha=0.2))(input)
  # x = Dense(512, activation=LeakyReLU(alpha=0.2))(x)
  # x = Reshape((7, 7, 64))(x)
...
geney  = generator(200)
# First Architecture Update --> Change the filter size from 100 (baseline) to 200
# geney = generator(100)
